...
<div class="body1">
  <div class="main">
    ...
    <header>
      <div class="wrapper">
        <h1><a href="/l" id="logo">Hope Center</a></h1>
        <nav>
          <ul id="top_nav">
        ...
        <nav>
          <ul id="menu">
            ...
            <li id="menu_active"><a href="/help">How to Help</a></li>
    ...
    <article id="content">
          ...
          <div class="line1">
            <div class="line2 wrapper">
              <section class="col1">
                ...
                <div class="pad_bot1">
                  <figure><img src="storage/page2_img1.jpg" alt=""></figure>
                </div>
                 </section>
              <section class="col1 pad_left1">
                <h2 class="color2"><strong>J</strong>oin<span>Volunteer</span></h2>
                <div class="pad_bot1">
                  <figure><img src="storage/page2_img2.jpg" alt=""></figure>
                </div>
                </section>
              <section class="col1 pad_left1">
                <h2 class="color3"><strong>A</strong>dopt<span>Children</span></h2>
                <div class="pad_bot1">
                  <figure><img src="storage/page2_img3.jpg" alt=""></figure>
                </div>
                 </section>
            </div>
          </div>
      ...
      <div class="wrapper">
        <div class="box2">
          <div class="wrapper">
            <section class="col1">
              <div class="wrapper"> <a href="/donations" class="left marg_right1"><img src="storage/banner.jpg" alt=""></a>
                <p class="pad_bot2"><strong>How Can You Donate?</strong></p>
                You can donate to us online or through visiting our orphanage. </div>
            </section>
          </div>
        </div>
      </div>
      ...
      <div class="wrapper">
        <nav>
          <ul id="footer_menu">
            ...
            <li><a href="/mission">Our Mission</a></li>
            <li class="active"><a href="/help">How to Help</a></li>
